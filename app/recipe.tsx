...
import { View, Text, Image, FlatList, ScrollView, StyleSheet, ActivityIndicator, TouchableOpacity } from "react-native";
import { useRouter, useLocalSearchParams } from "expo-router";

const styles = StyleSheet.create({
  container: { flex: 1, padding: 20, backgroundColor: "#FFF3E0" },
  title: { fontSize: 24, fontWeight: "bold", textAlign: "center", marginBottom: 10 },
  mealImage: { width: "100%", height: 250, borderRadius: 10, marginBottom: 15 },
  sectionTitle: { fontSize: 20, fontWeight: "bold", marginBottom: 5 },
  ingredientText: { fontSize: 16, marginBottom: 3 },
...
export default function RecipeScreen() {
  ...
  const { mealId } = useLocalSearchParams(); // ✅ Get meal ID from navigation params
  ...
  keyExtractor={(item, index) => index.toString()} // ✅ Fix duplicate keys
